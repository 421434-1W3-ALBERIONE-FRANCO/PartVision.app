...
class UsuarioControllerTest {
    ...
    private UsernamePasswordAuthenticationToken createAdminAuth(Long id, String username) {
        AuthenticatedUser principal = new AuthenticatedUser(id, username);
    ...
    void listar_comoAdmin_devuelve200() throws Exception {
        ...
        mvc.perform(get("/api/v1/usuarios").with(authentication(createAdminAuth(1L, "admin"))))
    ...
    void crear_comoAdmin_devuelve201() throws Exception {
        ...
        mvc.perform(post("/api/v1/usuarios")
                        .with(authentication(createAdminAuth(1L, "admin")))
    ...
    void toggleActivo_otroUsuario_devuelve200() throws Exception {
        ...
        mvc.perform(patch("/api/v1/usuarios/2/activo").with(authentication(createAdminAuth(1L, "admin"))))
                .andExpect(status().isOk())
    ...
    void toggleActivo_mismoUsuario_devuelve422() throws Exception {
        mvc.perform(patch("/api/v1/usuarios/1/activo").with(authentication(createAdminAuth(1L, "admin"))))
